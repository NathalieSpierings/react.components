...
const IconesFolder: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg id="svg_icones_folder" viewBox="0 0 70 70" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g id="folder">
            <path
                fill="var(--icones-20)"
