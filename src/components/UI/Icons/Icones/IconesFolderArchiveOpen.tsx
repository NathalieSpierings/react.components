...
const IconesFolderArchiveOpen: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg id="icones_folder_archive_open" viewBox="0 0 70 70" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g id="folder">
            <path
                fill="var(--icones-20)"
...
export default IconesFolderArchiveOpen;
