...
const IconesFolderBin: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg id="svg_icones_folder_bin" viewBox="0 0 70 70" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g id="folder">
            <path
                fill="var(--icones-20)"
            ...
            <path fill="var(--icones-10)" d="M63.43,26.13a3.91,3.91,0,0,1,3.77,4.64l-4.74,22.4v-27Z" />
        </g>
...
export default IconesFolderBin;
